...
function Plan({ name, price, description, href, features, featured = false }: IPlan) {
    return (
        <section className={clsx('flex flex-col rounded-3xl px-6 sm:px-8', featured ? 'order-first bg-blue-600 py-8 lg:order-none' : 'lg:py-8')}>
            ...
            <p className="font-display order-first text-5xl font-light tracking-tight text-white">{price}</p>
