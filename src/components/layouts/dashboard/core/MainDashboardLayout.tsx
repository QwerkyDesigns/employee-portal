...
import { ChevronRightIcon, ChevronUpDownIcon, EllipsisVerticalIcon, MagnifyingGlassIcon } from '@heroicons/react/20/solid';
import { DashboardContext, DashboardContextType } from '@/lib/contexts/DashboardContext';
import { useRouter } from 'next/router';
import { Dialog, Transition } from '@headlessui/react';
import { classNames } from '@/pages/portal';
...
export const MainDashboardLayout = ({ pageName, session, children }: DashboardProps) => {
                                    ...
                                    <a href="#" className="group block flex-shrink-0">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                ...
                                                <p className="text-sm font-medium text-gray-500 group-hover:text-gray-700">View Account</p>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                ...
                <div className="flex min-h-0 flex-1 flex-col border-r border-gray-200 bg-white">
                    ...
                    <div className="flex flex-shrink-0  border-gray-200 p-4">
                        <a href="#" className="group block w-full flex-shrink-0">
                            <div className="flex items-center">
                                <div
                                    className="group flex w-full items-center rounded-md px-2 py-2 text-sm font-medium text-gray-500 hover:text-gray-700"
                                    onClick={() => {
                                        signOut({
                                            callbackUrl: '/login'
                                        });
                    ...
                    {session && (
                        <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                            <a href="/portal/account" className="group block w-full flex-shrink-0">
                                <div className="flex items-center">
                                    <div>
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <p className="text-xs font-medium text-gray-500 group-hover:text-gray-700">View Account</p>
                                    </div>
                                </div>
                            </a>
                        </div>
