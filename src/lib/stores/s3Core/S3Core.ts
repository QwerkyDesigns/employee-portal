...
class S3Core {
    ...
    async writeFile(file: CoreFile, uploadOptions: S3.ManagedUpload.ManagedUploadOptions, prefix: string): Promise<ImageLocationDetails> {
    ...
    async writeFiles(files: CoreFile[], uploadOptions: S3.ManagedUpload.ManagedUploadOptions, prefix: string): Promise<ImageLocationDetails[]> {
