...
export default function ChooseTopUpMethod() {
  ...
  return (
    <DashboardLayout pageName="Manual Top Up">
      <p>
        Lets put somme useful information on this page for customers to consider
        before we send them to stripe
      </p>
      <p>
        We can also provide a custom checkout page design that also presents
        this info but maybe more concisely. Have a think about it :D
      </p>
